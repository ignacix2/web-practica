...
switch ($action) {
    ...
    case 'categories':
        ...
        require __DIR__ . "/PRACTICA1/PRACTICA1/resources/resource_category_list.php";
        break;

    case 'productes':
        // Mostra el llistat de productes d'una categoria específica
        require __DIR__ . "/PRACTICA1/PRACTICA1/resources/resource_product_list.php";
        break;

    case 'detalle_producte':
        // Mostra el detall del producte (Navegació tradicional de la Sessió 2)
        require __DIR__ . "/PRACTICA1/PRACTICA1/resources/resource_product_detail.php";
        break;

    case 'registre':
        // Formulari i processament del registre d'usuari (Sessió 3)
        require __DIR__ . "/PRACTICA1/PRACTICA1/resources/resource_registre.php";
        break;
    ...
    case 'productes_json':
        ...
        require __DIR__ . "/PRACTICA1/PRACTICA1/controller/products_json.php";
        break;

    case 'detall_producte_json':
        // Endpoint per a obtenir el detall del producte via FETCH (Sessió 3)
        require __DIR__ . "/PRACTICA1/PRACTICA1/controller/product_detail_json.php";
        break;
